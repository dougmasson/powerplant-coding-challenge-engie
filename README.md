...
- .NET 8
- Visual Studio 2022 version 17.8.0 or higher (recommend version 17.8.3)
- Postman
- Docker
...
Navigate to the `src\PowerCalculator.WebApi` folder and type the following command:
...
Navigate to the root folder, where contains the `Dockerfile` and type the following command:
...
- Example of [colletion](ProductionPlan.postman_collection.json) to import;
